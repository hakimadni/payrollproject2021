      ...
      <div class="col-12 col-sm-8 offset-sm-2 col-md-10 offset-md-3 col-lg-6 offset-lg-3 col-xl-6 offset-xl-3">
        ...
        <div class="card card-primary">
          <div class="card-header">
            <h4>Edit Family Status</h4></div>

          <div class="card-body">
            <form method="POST" action="/family_status/{{$FamilyStatus->id}}" class="needs-validation" novalidate="">
              @csrf
              @method('put')
              <div class="form-group">
                <label for="name">Family Status Name</label>
                <input id="name" type="text" class="form-control" name="nama" tabindex="1" value="{{$FamilyStatus->nama}}" required autofocus disabled>
              ...
              <div class="form-group">
                ...
                <input id="value" type="number" class="form-control" name="value" tabindex="1" value="{{$FamilyStatus->value}}" required autofocus>
                <div class="invalid-feedback">
